...
extension TextStyleEx on TextStyle {
  ...
  TextStyle get s8 => copyWith(fontSize: FontSizeManager.s8);

  TextStyle get s10 => copyWith(fontSize: FontSizeManager.s10);

  TextStyle get s11 => copyWith(fontSize: FontSizeManager.s11);
  ...
  TextStyle get s22 => copyWith(fontSize: FontSizeManager.s22);
